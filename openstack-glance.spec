...
stestr run --black-regex 'glance.tests.unit.common.test_format_inspector.TestFormatInspectors.test_vdi|glance.tests.unit.common.test_format_inspector.TestFormatInspectors.test_qed_always_unsafe'
...
%changelog
* Tue Jan 31 2023 RDO <dev@lists.rdoproject.org> 1:25.1.0-1
- Update to 25.1.0

* Wed Oct 05 2022 RDO <dev@lists.rdoproject.org> 1:25.0.0-1
- Update to 25.0.0

* Fri Sep 16 2022 RDO <dev@lists.rdoproject.org> 1:25.0.0-0.1.0rc1
